  ...
  return (
    <div className="h-full flex flex-col px-5 pt-4 pb-6 overflow-y-auto">
      ...
      <header className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-text font-display">内功养生法</h1>
          <p className="text-sm text-text-secondary mt-1">传统养生，身心调和</p>
        </div>
        <motion.button
...
function CategoryCard({ category }: { category: NeimenCategory }) {
  const navigate = useNavigate()
    ...
    >
      ...
      <div className="relative h-full flex flex-col p-4">
        ...
        <div
          ...
          style={{ backgroundColor: (category.color || '#10B981') + '18', color: category.color || '#10B981' }}
        >
